...
class OpticaPruebasPage extends StatelessWidget {
  const OpticaPruebasPage({super.key});
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            const CustomPageHeader(title: 'Pruebas'),
            const SizedBox(height: 12),
            Center(
              child: ElevatedButton(
                onPressed: () {},
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    _cardSection('Schirmer', [
                      _inputField('OD'),
                      const SizedBox(height: 8),
                      _inputField('OI'),
                    ]),
                    _cardSection('TBUT (Tiempo de Ruptura de la Película Lagrimal)', [
                      _inputField('OD'),
                      const SizedBox(height: 8),
                      _inputField('OI'),
                    ]),
                    _cardSection('Visión Binocular / Estereopsis', [
                      _inputField('Stereo Fly Test'),
                    ]),
                    const SizedBox(height: 24),
                    _actionButton('Guardar'),
                    _actionButton('Finalizar'),
                    const SizedBox(height: 24),
                  ],
                ),
              ),
